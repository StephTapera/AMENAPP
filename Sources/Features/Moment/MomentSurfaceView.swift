...
public struct AmenMomentSurfaceView: View {
    ...
    public var client: AmenMomentDeepenClient = .shared
    ...
    public init(moment: AmenMoment, client: AmenMomentDeepenClient = .shared) {
        self.moment = moment
        self.client = client
    }
        ...
        VStack(alignment: .leading, spacing: 10) {
            LazyVGrid(columns: [GridItem(.adaptive(minimum: 148), spacing: 10)], spacing: 10) {
                ForEach(AmenMomentDeepenAction.allCases) { action in
                    ...
                    .background(deepenEnabled ? AmenMomentGlass.activePill : AmenMomentGlass.disabledPill)
