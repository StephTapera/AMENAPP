...
struct DiscoveryPerson: Identifiable, Codable, Hashable, Equatable {
    let id: String
...
struct DiscoveryPost: Identifiable, Codable, Hashable, Equatable {
    let id: String
    let authorId: String
...
struct DailyVerseData: Identifiable, Codable, Hashable, Equatable {
    let id: String
    let text: String
