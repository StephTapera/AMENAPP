...
exports.moderateCreatorAsset = void 0;
const https_1 = require("firebase-functions/v2/https");
const admin = __importStar(require("firebase-admin"));
exports.moderateCreatorAsset = (0, https_1.onCall)({ enforceAppCheck: true }, async (request) => {
    ...
    if (!assetID) {
        throw new https_1.HttpsError("invalid-argument", "Missing assetID");
    }
...
//# sourceMappingURL=moderateCreatorAsset.js.map