...
exports.queueProcessingJob = void 0;
const https_1 = require("firebase-functions/v2/https");
const admin = __importStar(require("firebase-admin"));
exports.queueProcessingJob = (0, https_1.onCall)({ enforceAppCheck: true }, async (request) => {
    ...
    if (!projectID || !type) {
        throw new https_1.HttpsError("invalid-argument", "Missing projectID or type");
    }
...
//# sourceMappingURL=queueProcessingJob.js.map