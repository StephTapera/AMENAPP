...
function requireAppCheck(request: { app?: unknown }): void {
...
// prefixForType is used in type validation; suppress unused-variable warning
void prefixForType;
