...
export const submitChurchVerificationClaim = onCall({ region: REGION, enforceAppCheck: true }, async (request) => {
...
export const reviewChurchVerificationClaim = onCall({ region: REGION, enforceAppCheck: true }, async (request) => {
    requireAppCheck(request as CallableRequest);
...
export const submitChurchProfileEdit = onCall({ region: REGION, enforceAppCheck: true }, async (request) => {
    requireAppCheck(request as CallableRequest);
    const uid = requireAuth(request as CallableRequest);
    const churchId = readChurchId(request as CallableRequest);
...
export const queueChurchMediaModeration = onCall({ region: REGION, enforceAppCheck: true }, async (request) => {
    requireAppCheck(request as CallableRequest);
    const uid = requireAuth(request as CallableRequest);
    const churchId = readChurchId(request as CallableRequest);
...
export const reviewChurchModerationItem = onCall({ region: REGION, enforceAppCheck: true }, async (request) => {
    requireAppCheck(request as CallableRequest);
    const reviewerId = requireAdmin(request as CallableRequest);
...
export const refreshChurchLivestreamState = onCall({ region: REGION, enforceAppCheck: true }, async (request) => {
    requireAppCheck(request as CallableRequest);
    const churchId = readChurchId(request as CallableRequest);
    const churchSnapshot = await loadChurch(churchId);
...
export const syncYouTubeChurchStreams = onCall({ region: REGION, enforceAppCheck: true }, async (request) => {
    requireAppCheck(request as CallableRequest);
...
export const updateChurchLiveSignals = onCall({ region: REGION, enforceAppCheck: true }, async (request) => {
    requireAppCheck(request as CallableRequest);
    requireAdmin(request as CallableRequest);
    const churchId = readChurchId(request as CallableRequest);
...
export const regenerateChurchGroundedSummary = onCall({ region: REGION, enforceAppCheck: true }, async (request) => {
    requireAppCheck(request as CallableRequest);
    requireAdmin(request as CallableRequest);
    const churchId = readChurchId(request as CallableRequest);
    const churchSnapshot = await loadChurch(churchId);
...
export const generateGroundedChurchResponse = onCall({ region: REGION, enforceAppCheck: true }, async (request) => {
    requireAppCheck(request as CallableRequest);
