 ...
 */
async function drainCollectionRef(
 ...
 */
async function deleteAiBibleStudyConversations(userId: string): Promise<void> {
    while (true) {
        const snap = await db
 ...
 */
async function deleteRealtimeSessions(userId: string): Promise<void> {
    while (true) {
        const snap = await db
