...
exports.FIELD_CAP = exports.RAW_INPUT_CAP = void 0;
exports.sanitizeImportText = sanitizeImportText;
exports.wrapAsInertDocument = wrapAsInertDocument;
exports.stripExcludedContent = stripExcludedContent;
exports.capField = capField;
exports.isReceiptVerified = isReceiptVerified;
exports.enforceMinorConstraints = enforceMinorConstraints;
// ---------------------------------------------------------------------------
// Caps (must match ContextSanitizer.rawInputCap / fieldCap)
// ---------------------------------------------------------------------------
exports.RAW_INPUT_CAP = 16000;
exports.FIELD_CAP = 600;
// ---------------------------------------------------------------------------
...
function sanitizeImportText(raw) {
    ...
    // 1. Cap.
    const capped = capText(raw ?? "", exports.RAW_INPUT_CAP);
 ...
 */
function wrapAsInertDocument(sanitized) {
...
function stripExcludedContent(s) {
    let out = s;
...
function capField(field) {
    return capText(field ?? "", exports.FIELD_CAP);
}
/**
 ...
 */
function isReceiptVerified(passId) {
 ...
 */
function enforceMinorConstraints(uid, capability, ageTier) {
...
// Internals
// ---------------------------------------------------------------------------
function neutralizeInjections(s) {
    let out = s;
    let total = 0;
 ...
 */
function makePassId(content, originalLength) {
