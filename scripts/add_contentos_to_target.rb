#!/usr/bin/env ruby
# add_contentos_to_target.rb
# Adds all 6 ContentOS Swift files to the AMENAPP Xcode target.
...
NEW_FILES = [
  "AMENAPP/ContentOS/ContentOSModels.swift",
  "AMENAPP/ContentOS/ContentPermissionEngine.swift",
  "AMENAPP/ContentOS/ContentForwardingService.swift",
  "AMENAPP/ContentOS/ContentAIRouter.swift",
  "AMENAPP/ContentOS/ContentApprovalSheet.swift",
  "AMENAPP/ContentOS/ContentDiscussionLauncher.swift",
]
