                ...
                NavigationStack {
                    VStack(spacing: 24) {
                        Image(systemName: "bubble.left.and.bubble.right")
                            ...
                            .foregroundStyle(Color(uiColor: .tertiaryLabel))
                            .accessibilityHidden(true)
                        Text("Discussion creation is off")
                            .font(.callout.weight(.semibold))
                            .foregroundStyle(Color(uiColor: .label))
                            .multilineTextAlignment(.center)
                        Text("Enable the universal composer flag to create a real room from this context.")
                            .font(.footnote)
                            .foregroundStyle(Color(uiColor: .secondaryLabel))
                            .multilineTextAlignment(.center)
    ...
    private var featureUnavailableView: some View {
        VStack(spacing: 16) {
            Image(systemName: "bubble.left.and.bubble.right")
                ...
                .foregroundStyle(Color(uiColor: .tertiaryLabel))
                .accessibilityHidden(true)
            Text("Discussions are off")
                .font(.callout.weight(.semibold))
                .foregroundStyle(Color(uiColor: .label))
            Text("Enable CommunityOS discussions to load rooms, messages, and smart follow-ups.")
                .font(.footnote)
                .foregroundStyle(Color(uiColor: .secondaryLabel))
                .multilineTextAlignment(.center)
