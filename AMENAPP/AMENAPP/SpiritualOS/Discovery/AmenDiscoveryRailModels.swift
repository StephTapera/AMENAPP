...
enum DiscoveryRailType: String, CaseIterable {
    ...
    case trendingStudies      = "trending_studies"
    ...
    var title: String {
        ...
        case .trendingStudies:     return "Trending Studies"
    ...
    var subtitle: String {
        ...
        case .trendingStudies:     return "What the community is studying"
    ...
    var iconName: String {
        ...
        case .trendingStudies:     return "flame"
