...
// MARK: - AuthenticityLabel helpers
...
extension AuthenticityLabel {
    static func labels(for provenance: MediaProvenance) -> [AuthenticityLabel] {
        ...
        case .clean:
            labels.append(AuthenticityLabel(kind: .realMedia, title: "Real Media",
                detail: "No synthetic modifications detected.", confident: true))
        case .aiAssistedMetadata:
            labels.append(AuthenticityLabel(kind: .aiAssistedCaptions, title: "AI Assisted",
                detail: "AI was used for metadata or captions.", confident: true))
        case .aiEditedMedia:
            labels.append(AuthenticityLabel(kind: .editedRealFootage, title: "AI Edited",
                detail: "Real footage with AI editing applied.", confident: true))
        case .aiGeneratedMedia:
            labels.append(AuthenticityLabel(kind: .syntheticWarning, title: "AI Generated",
                detail: "This media was generated by AI.", confident: true))
        case .deepfakeRisk:
            labels.append(AuthenticityLabel(kind: .syntheticWarning, title: "Deepfake Risk",
                detail: "This media may be synthetically generated.", confident: false))
        case .unknown:
            labels.append(AuthenticityLabel(kind: .pendingReview, title: "Pending Review",
                detail: "Authenticity is being reviewed.", confident: false))
        }

        if provenance.capturedOnDevice {
            labels.append(AuthenticityLabel(kind: .creatorVerified, title: "Captured On Device",
                detail: "Media was captured directly on the creator's device.", confident: true))
        }
    ...
    var systemIcon: String {
        switch kind {
        case .realMedia:              return "checkmark.seal.fill"
        case .creatorVerified:        return "person.badge.shield.checkmark.fill"
        case .communityVerified:      return "person.3.fill"
        case .churchMedia:            return "building.columns.fill"
        case .editedRealFootage:      return "wand.and.sparkles"
        case .aiAssistedCaptions:     return "text.badge.checkmark"
        case .aiAssistedTranslation:  return "character.bubble.fill"
        case .transcriptApproved:     return "checkmark.bubble.fill"
        case .pendingReview:          return "clock.badge.questionmark"
        case .syntheticWarning:       return "exclamationmark.triangle.fill"
        }
    }
}
