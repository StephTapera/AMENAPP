// MediaAuthenticityScoreView.swift
...
/// thin arc ring background. Tapping it presents MediaAuthenticityScoreSheet.
struct MediaAuthenticityScorePill: View {

    let score: MediaAuthenticityScore
    ...
    var body: some View {
        if flags.authenticityScoresEnabled {
            ...
            .sheet(isPresented: $showSheet) {
                MediaAuthenticityScoreSheet(score: score)
            }
        }
    }
}
...
struct MediaAuthenticityScoreSheet: View {
