...
final class UserProfileMiniViewModel: ObservableObject {
    ...
    /// Whether the context panel should be shown. False when signal is too low.
    ...
    var followButtonLabel: String {
        ...
        // Only show "Following" for the .follow case when the user is already followed.
