...
// BereanEmptyState was removed as part of the empty-state consolidation
// (Agent D, 2026-05-28). The active empty state is BereanLandingEmbedded,
// which is already used at line 183 above.
