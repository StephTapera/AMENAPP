...
struct BereanStudyCardView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            // P1-1: AI disclosure footnote (behind berean_ai_disclosure_enabled flag)
            if AMENFeatureFlags.shared.bereanAiDisclosureEnabled {
                Text("AI-assisted content · Not pastoral guidance")
                    .font(.caption2)
                    .foregroundStyle(.secondary)
                    .accessibilityLabel("This content was generated by AI and is not a substitute for pastoral guidance.")
            }
        }
        .padding(14)
        .background(
