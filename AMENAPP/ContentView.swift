...
struct HomeView: View {
    ...
    var body: some View {
        ...
        NavigationStack {
            mainScrollContent
                ...
                .sheet(isPresented: $showCommunitiesSheet) { communitiesSheet }
    ...
    @ViewBuilder private var communitiesSheet: some View {
        NavigationStack {
            List {
                ForEach(Array(LegacyFeedMode.allCases), id: \.self) { (mode: LegacyFeedMode) in
                    Button {
                        selectedFeedMode = mode
            ...
            .toolbar {
                ToolbarItem(placement: .cancellationAction) {
                    Button("Done") { showCommunitiesSheet = false }
                }
            }
        }
    }
    ...
    private var mainScrollContent: some View {
        ScrollViewReader { proxy in
            ...
            .modifier(ScrollOffsetTracker { handleScroll(offset: $0) })
...
/// Applies `onScrollGeometryChange` on iOS 18+ and is a no-op on earlier versions.
