...
enum SuggestedRailAnalytics {
    ...
    private static func track(_ event: AMENAnalyticsEvent) {
        Task { @MainActor in
            AMENAnalyticsService.shared.track(event)
        }
    }
    ...
    static func trackPeekOpen(userId: String, surface: SuggestionSurface) {
        track(.suggestionPeekOpen(suggestedUserId: userId, surface: surface.rawValue))
    }
    ...
    static func trackPeekExpand(userId: String, surface: SuggestionSurface) {
        track(.suggestionPeekExpand(suggestedUserId: userId, surface: surface.rawValue))
    }
