...
| **Codex — Smart Composer surfaces** | `AMENAPP/CreatePostView.swift`, `AMENAPP/PostComposerSmartDetectionService.swift`, `AMENAPP/SmartPostContextTray.swift`, compile-fix files only | 2026-06-10 | **BLOCKED-ON-ALL-CLEAR** — fixes committed; owed on GREEN NOW all-clear: screenshots + wiring cert for Smart Composer topic chips, warning review sheet, link/audience notes, and post confirmation gate |
